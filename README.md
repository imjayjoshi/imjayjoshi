<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=500&size=30&pause=1000&color=61DAFB&center=true&vCenter=true&width=900&height=100&lines=Hi%2C+I'm+Jay+Joshi+👋;Full+Stack+Developer;AI+Integrator;Let%E2%80%99s+build+something+amazing+together!">
</p>
...
- Implementing Redux for state management and React Router for smooth user experience.

I’ve completed two internships:

- **Python Developer Intern** – built multiple GUI-based desktop applications using Tkinter, focusing on clean UI and functional design.

- **AI Intern** – developed AI-powered web apps using Streamlit, integrating intelligent data-driven functionalities.

Earlier, as a **Teaching Assistant** at BECIL Traning Centre, I taught Basic Web Development to over 250 students through hands-on labs and interactive sessions.

When I’m not coding, I spend time reading tech blogs on Medium and exploring official documentation to stay up-to-date with the latest technologies.

## ✨ Featured Projects

- 🗣️ **SpeakWise Site** – Real-time AI-powered language pronunciation app with feedback and scoring system (MERN Stack)
- 💄 **BlackPearl Cosmetics** – Freelance e-commerce website built with React.js and Supabase for secure and dynamic product management
- 🧾 **ResuMate** – Real-time AI-powered ATS resume generator with smart scoring and live editing (React.js + PostgreSQL)
...
- ⚛️ ThreeJS for Creating Animations
- ☁️ Amazon Web Services and Cloud Services
- 🤖 AI Integration in application with APIs
